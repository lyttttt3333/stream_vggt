...
def create_fake_frames(num_frames=4, img_channels=3, img_height=256, img_width=256):
    images = torch.zeros((num_frames, img_channels, img_height, img_width), dtype=torch.float32)
